...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        self.actor.train(loader.training)           # 设置模型的模式：训练 or 评估
        torch.set_grad_enabled(loader.training)     # 启用或禁用梯度计算
        ...
        for i, data in enumerate(loader, 1):    # 遍历所有数据
