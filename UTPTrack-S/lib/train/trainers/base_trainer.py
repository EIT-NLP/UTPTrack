        ...
        if self.settings.env.workspace_dir is not None:
            ...
            if self.settings.local_rank in [-1, 0] and self.settings.dist_rank == 0:
                ...
                if not os.path.exists(self._checkpoint_dir):
                    print("Training with multiple GPUs. checkpoints directory doesn't exist. Create checkpoints directory")
        ...
        for i in range(num_tries):
            try:
                ...
                for epoch in range(self.epoch+1, max_epochs+1):
                    ...
                    save_epochs = []
                    if epoch > (max_epochs - 10) or save_every_epoch or epoch % 10 == 0 or epoch in save_epochs:
