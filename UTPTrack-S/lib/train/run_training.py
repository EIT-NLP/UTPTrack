...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None, use_lmdb=False, use_wandb=False):
...
def main():
    ...
    if args.local_rank != -1:
        ...
        print(f"dist_rank: {dist.get_rank()}, local_rank: {args.local_rank}")
    else:
    ...
    run_training(args.script, args.config, cudnn_benchmark=args.cudnn_benchmark,
                 ...
                 use_lmdb=args.use_lmdb, use_wandb=args.use_wandb)
