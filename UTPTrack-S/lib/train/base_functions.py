    ...
    for name in name_list:
        ...
        if name == "LASOT":
            if settings.use_lmdb:
                ...
                print("Building lasot dataset")
                datasets.append(Lasot(settings.env.lasot_dir, split='train', image_loader=image_loader,
                                      multi_modal_vision=settings.multi_modal_vision,
                                      multi_modal_language=settings.multi_modal_language,
                                      use_nlp=settings.use_nlp['LASOT']))
        if name == "VASTTRACK":
            print("Building vasttrack dataset")
        ...
        if name == "GOT10K_vottrain":
            if settings.use_lmdb:
                print("Building got10k dataset from lmdb")
        ...
        if name == "GOT10K_train_full":
            if settings.use_lmdb:
                print("Building got10k_train_full dataset from lmdb")
                ...
                print("Building got10k_train_full dataset")
        ...
        if name == "COCO17":
            if settings.use_lmdb:
                print("Building coco2017 dataset from lmdb")
                ...
                print("Building coco2017 dataset")
        ...
        if name == "VID":
            if settings.use_lmdb:
                print("Building vid dataset from lmdb")
                datasets.append(ImagenetVID_lmdb(settings.env.imagenet_lmdb_dir, image_loader=image_loader))
            else:
                print("Building vid dataset")
                datasets.append(ImagenetVID(settings.env.imagenet_dir, image_loader=image_loader))
        if name == "TRACKINGNET":
            if settings.use_lmdb:
                print("Building trackingnet dataset from lmdb")
                ...
                print("Building trackingnet dataset")
        ...
        if name == "DepthTrack_val":
            print("Building depthtrack_val dataset")
            datasets.append(DepthTrack(settings.env.depthtrack_dir,
                                       dtype='color' if not settings.multi_modal_vision else 'rgbcolormap',
                                       split='val',
                                       multi_modal_vision=settings.multi_modal_vision,
        ...
        if name == "LasHeR_all":
            print("Building lasher_all dataset")
        ...
        if name == "LasHeR_train":
            print("Building lasher_train dataset")
            datasets.append(LasHeR(settings.env.lasher_dir,
                                   dtype='color' if not settings.multi_modal_vision else 'rgbrgb',
                                   split='train',
                                   multi_modal_vision=settings.multi_modal_vision,
        ...
        if name == "LasHeR_val":
            print("Building lasher_val dataset")
            datasets.append(LasHeR(settings.env.lasher_dir,
                                   dtype='color' if not settings.multi_modal_vision else 'rgbrgb',
                                   split='val',
                                   multi_modal_vision=settings.multi_modal_vision,
        ...
        if name == "REFCOCOG":
            print("Building refcocog dataset")
        ...
        if name == "TNL2K_train":
            print("Building tnl2k_train dataset")
            ...
            print("Building otb99_train dataset")
