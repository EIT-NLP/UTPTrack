...
cfg.MODEL.ENCODER.CM_BACK_RATIO = []
cfg.MODEL.ENCODER.TE_LOC = []
cfg.MODEL.ENCODER.TE_KEEP_RATIO = []
cfg.MODEL.ENCODER.TM_BACK_RATIO = []
cfg.MODEL.ENCODER.SIMILARITY_TYPE = None
...
# TRAIN.CE
cfg.TRAIN.PRUNING_START_EPOCH = 12  # candidate elimination start epoch
cfg.TRAIN.PRUNING_WARM_EPOCH = 48  # candidate elimination warm up epoch
