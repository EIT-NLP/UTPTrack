...
# 支持CE & TE
cfg.MODEL.ENCODER.CE_LOC = []
cfg.MODEL.ENCODER.CE_KEEP_RATIO = []
cfg.MODEL.ENCODER.DTE_LOC = []
cfg.MODEL.ENCODER.DTE_KEEP_RATIO = []
cfg.MODEL.ENCODER.STE_LOC = []
cfg.MODEL.ENCODER.STE_KEEP_RATIO = []
cfg.MODEL.ENCODER.TOKEN_TYPE_AWARE_PRUNING = None
cfg.MODEL.ENCODER.MULTIMODAL_AWARE_PRUNING = False
cfg.MODEL.ENCODER.MULTIMODAL_AWARE_PRUNING_TARGET = None
...
# TRAIN.CE
cfg.TRAIN.CE_START_EPOCH = 12  # candidate elimination start epoch
cfg.TRAIN.CE_WARM_EPOCH = 48  # candidate elimination warm up epoch
