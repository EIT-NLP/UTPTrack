...
class CEATE_HiViTAttentionBlock(nn.Module):
    ...
    def forward(self, xz, rel_pos_bias=None, attn_mask=None,
        ...
        if self.keep_ratio_sz < 1 and (keep_ratio_sz is None or keep_ratio_sz < 1):
            ...
            xz, global_index_sz, removed_index_sz, ce_template_mask, _ = static_template_elimination(
        ...
        return (xz, global_index_sz, global_index_dz, removed_index_sz, removed_index_dz, global_index_x, removed_index_x,
                attn, ce_template_mask)


class CEATE_Fast_iTPN(nn.Module):
        ...
        for i, blk in enumerate(self.blocks[-self.num_main_blocks:]):
            ...
            if self.grad_ckpt:
                (xz, global_index_sz, global_index_dz, removed_index_sz, removed_index_dz, global_index_x,
                 removed_index_x, attn, ce_template_mask) = checkpoint.checkpoint(
                    blk, xz, rel_pos_bias,
                    global_index_sz=global_index_sz,
                    global_index_dz=global_index_dz,
                    global_index_x=global_index_x,
                ...
                (xz, global_index_sz, global_index_dz, removed_index_sz, removed_index_dz, global_index_x,
                 removed_index_x, attn, ce_template_mask) = blk(
                    xz, rel_pos_bias,
                    global_index_sz=global_index_sz,
                    global_index_dz=global_index_dz,
                    global_index_x=global_index_x,
...
@register_model
def ceate_fastitpnt(pretrained=False, pos_type="interpolate", pretrain_type="", patchembed_init="copy", **kwargs):
    model = CEATE_Fast_iTPN(
...
@register_model
def ceate_fastitpns(pretrained=False, pos_type="interpolate", pretrain_type="", patchembed_init="copy", **kwargs):
    model = CEATE_Fast_iTPN(
...
@register_model
def ceate_fastitpnb(pretrained=False, pos_type="interpolate", pretrain_type="", patchembed_init="copy", **kwargs):
    model = CEATE_Fast_iTPN(
...
@register_model
def ceate_fastitpnl(pretrained=False, pos_type="interpolate", pretrain_type="", patchembed_init="copy", **kwargs):
    model = CEATE_Fast_iTPN(
