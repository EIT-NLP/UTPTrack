...
from lib.models.sutrack import blank_fastitpn as blank_fastitpn_module
from lib.models.sutrack import tome_fastitpn as tome_fastitpn_module
from lib.models.sutrack import ce_fastitpn as ce_fastitpn_module
from lib.models.sutrack import evit_fastitpn as evit_fastitpn_module
...
class Encoder(EncoderBase):
    ...
    def __init__(self, name: str,
                 ...
                 open_layers: list,
                 cfg=None):
        if "tome_fastitpn" in name.lower():
            encoder = getattr(tome_fastitpn_module, name)(
            ...
            if "itpnb" in name:
                ...
                num_channels = 512
        elif "evit_fastitpn" in name.lower():
            encoder = getattr(evit_fastitpn_module, name)(
                pretrained=is_main_process(),
                search_size=search_size,
                template_size=template_size,
                drop_rate=0.0,
                ...
                pretrain_type = cfg.MODEL.ENCODER.PRETRAIN_TYPE,
                patchembed_init = cfg.MODEL.ENCODER.PATCHEMBED_INIT,
                evit_loc=cfg.MODEL.ENCODER.CE_LOC,
                evit_keep_ratio = cfg.MODEL.ENCODER.CE_KEEP_RATIO,
            )
            if "itpnb" in name:
                num_channels = 512
            elif "itpnl" in name:
                ...
                num_channels = 512
        elif "ce_fastitpn" in name.lower():
