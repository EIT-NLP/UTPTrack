...
if __name__ == '__main__':
    ...
    if dataset_name == 'GTOT':
        ...
        seq_home = '/hkfs/work/workspace/scratch/tum_yvc3016-compression/dataset/RGB-T234'
        seq_list = [f for f in os.listdir(seq_home) if isdir(join(seq_home,f))]
        seq_list.sort()
    elif dataset_name == 'LasHeR':
        seq_home = '/hkfs/work/workspace/scratch/tum_yvc3016-compression/dataset/lasher/testingset'
        seq_list = [f for f in os.listdir(seq_home) if isdir(join(seq_home,f))]
        seq_list.sort()
